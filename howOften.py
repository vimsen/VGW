...
myMAC = getMAC("eth0")
print 'MAC = ' + myMAC
temp_topic = "glimperop/" + myMAC + '/id000000000001/rest_temp'
humi_topic = "glimperop/" + myMAC + '/id000000000001/rest_humi'
rate_topic = "glimperop/" + myMAC + '/id000000000001/command'
print rate_topic
retain=True
